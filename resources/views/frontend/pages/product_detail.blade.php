...
@endsection
@section('title','TIEN-VI || DETALLE DEL PRODUCTO')
										...
										<div class="product-des">
											...
											<div class="short">
												...
												<div class="rating-main">
													...
													<a href="#" class="total-review">({{$product_detail['getReview']->count()}}) Revisión</a>
                                                </div>
                                                @php 
										...
										<div class="product-info">
											<div class="nav-main">
												...
												<ul class="nav nav-tabs" id="myTab" role="tablist">
													<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#description" role="tab">Descipción</a></li>
															...
															<div class="col-12">
																...
																<div class="comment-review">
																	<div class="add-review">
																		...
																		<p>YNuestra dirección de correo electrónico no será publicada. Los campos obligatorios están marcados</p>
																	</div>
