                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0)">Caja</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="checkout-form">
                                ...
                                <p>Por favor, regístrese para pagar más rápidamente</p>
                                <!-- Form -->
                                <div class="row">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="order-details">
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            {{-- <label class="checkbox-inline" for="1"><input name="updates" id="1" type="checkbox"> Pagos con Cheque</label> --}}
                                            <form-group>
        ...
        <div class="container">
            ...
            <div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-service">
						...
						<p>Pedidos superiores a 100.000 CL</p>
					</div>
					<!-- End Single Service -->
				</div>
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-service">
						...
						<p>En un plazo de 30 días devoluciones</p>
					</div>
					<!-- End Single Service -->
				</div>
				<div class="col-lg-3 col-md-6 col-12">
            ...
            <div class="inner-top">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-12">
                        ...
                        <div class="inner">
                            <h4>Boletín</h4>
                            <p> Suscríbete y obtén <span>10%</span> de descuento en su primera compra</p>
