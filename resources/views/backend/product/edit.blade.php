...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          <label for="is_featured">Aparece</label><br>
        ...
        <div class="form-group">
          <label for="price" class="col-form-label">Precio(CL) <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="commission" class="col-form-label">Comisión(CL) <span class="text-danger">*</span></label>
          <input id="commission" type="number" name="commission" placeholder="Enter commission"  value="{{old('commission')}}" class="form-control">
          @error('commission')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="default" {{(($product->condition=='default')? 'selected':'')}}>Predeterminado</option>
