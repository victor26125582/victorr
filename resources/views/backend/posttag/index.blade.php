...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Publicar Listas de Etiquetas</h6>
    ...
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">No se ha encontrado ninguna etiqueta de publicación!!! Por favor, cree post tag</h6>
        @endif
      </div>
    </div>
</div>
